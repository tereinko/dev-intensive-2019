    ...
    init {
        if (attrs != null) {
            ...
            mBorderWidth = a.getDimensionPixelSize(
                ru.skillbranch.devintensive.R.styleable.CircleImageView_civBorderWidth,
                convertDpToPixels(DEFAULT_BORDER_WIDTH_DP)
            )
            mBorderColor =
                a.getColor(ru.skillbranch.devintensive.R.styleable.CircleImageView_civBorderColor, DEFAULT_BORDER_COLOR)
